...
- A second neutral layer for sidebars, toolbars, and panels (slightly lighter or darker than the main background, depending on theme direction) to ground elements.
